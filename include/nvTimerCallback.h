...
class nvTimerCallback : public vtkCommand
{
    ...
    void Execute(vtkObject *vtkNotUsed(caller), unsigned long eventId, void *vtkNotUsed(callData)) override
    {
        ...
        for(const auto &neuron: nvNeurons)
        {
            ...
            // Iterate over the dendrite branches and add their positions to the
            // vtkPolyData
            ...
            // Iterate over the axon branches and add their positions to the
            // vtkPolyData
            ...
            // vtkSmartPointer<vtkPolyData> membranePolyData =
            // geometryFilter->GetOutput();
            ...
            // membraneActor->GetProperty()->SetColor(0.7, 0.7, 0.7);  // Set color to
            // gray
