#ifndef SYNAPTICGAP_H_INCLUDED
#define SYNAPTICGAP_H_INCLUDED
...
, public BodyShapeComponent
{
    ...
    private:
    // Initially, the SynapticGap is not initialised
    bool instanceInitialised = false;
    // Initially, the SynapticGap is not associated with a DendriteBouton
