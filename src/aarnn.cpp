...
#include "av_timer_callback.h"
#include "axon_hillock.h"
#include "config.h"
#include "dendrite_branch.h"
#include "neuron.h"
#include "neuron_parameters.h"
#include "nv_timer_callback.h"
#include "pulse_audioMic.h"
...
// */
//void computePropagationRate(const NeuronPtr& neuron)
//{
...
//                            const DendriteBranchPtr& dendriteBranch,
...
//                        const AxonBranchPtr& axonBranch,
//                        int&                               axon_branch_id,
//                        int&                               axon_id,
//                        int&                               axon_bouton_id,
//                        int&                               synaptic_gap_id,
...
//    SensoryReceptorPtr prevReceptor;
...
//            }
//
//            spdlog::debug("Creating visual ({}) input {} at ({}, {}, {})", j, i, shiftX, shiftY, shiftZ);
