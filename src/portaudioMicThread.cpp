...
int portaudioMicThread::run()
{
    ...
    PaSampleFormat sampleFormats[] = {paFloat32, paInt32, paInt24, paInt16, paInt8, paUInt8};

    double sampleRates[] = {8000.0, 16000.0, 22050.0, 32000.0, 44100.0, 48000.0, 96000.0, 192000.0};

    std::cout << "\n\nInput Devices Info\n" << std::endl;
    std::cout << std::left << std::setw(5) << "Index" << std::setw(20) << "Device Name" << std::setw(20) << "Host API"
              << std::setw(20) << "Max Input Channels" << std::setw(30) << "Supported Sample Rates" << std::setw(30)
    ...
    std::cout << std::left << std::setw(5) << "Index" << std::setw(20) << "Device Name" << std::setw(20) << "Host API"
              << std::setw(20) << "Max Output Channels" << std::setw(30) << "Supported Sample Rates" << std::setw(30)
              << "Supported Sample Formats" << std::endl;
    ...
    err = Pa_OpenStream(&stream,
                        &inputParameters[inputDeviceSelected],
                        &outputParameters[outputDeviceSelected],
                        SAMPLE_RATE,
                        FRAMES_PER_BUFFER,
                        paClipOff,
